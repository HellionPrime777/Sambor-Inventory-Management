...
namespace Inventory_Management.ViewModel
{
    ...
    {
        /// <summary>
        /// PartnersViewModel надає функціональність для відображення списку партнерів, додавання нового партнера, редагування та видалення партнера, 
        /// а також оновлення списку партнерів.
        /// </summary>
