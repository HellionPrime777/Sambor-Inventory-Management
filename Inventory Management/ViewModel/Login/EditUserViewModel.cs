...
namespace Inventory_Management.ViewModel
{
    ...
    {
        /// <summary>
        /// EditUserViewModel надає функціональність для редагування користувача, перевірки введених даних та взаємодії з UserLogin для зміни користувача в базі даних.
        /// </summary>
