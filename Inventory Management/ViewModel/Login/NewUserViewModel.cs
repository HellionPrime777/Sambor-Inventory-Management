...
namespace Inventory_Management.ViewModel
{
    ...
    {
        /// <summary>
        /// NewUserViewModel надає функціональність для створення нового користувача, перевірки введених даних та взаємодії з UserLogin для додавання користувача в базу даних.
        /// </summary>
