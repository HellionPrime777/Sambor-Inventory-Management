...
namespace Inventory_Management.Model
{
    ...
    {
        /// <summary>
        /// Клас EditItemModel надає загальну базу для моделей редагування елементів і містить логіку для збереження та закриття редагування. 
        /// Він також забезпечує зручний механізм сповіщення про зміну властивостей через успадкування від класу BindableBase.
        /// </summary>
