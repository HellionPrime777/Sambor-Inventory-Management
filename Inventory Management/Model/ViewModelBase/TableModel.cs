...
namespace Inventory_Management.Model
{
    ...
    {
        /// <summary>
        /// Клас TableModel надає розширену функціональність для моделей списків, включаючи можливість редагування, створення та видалення елементів. 
        /// Він використовує команди EditItemCommand, NewItemCommand та DeleteItemCommand, які можуть бути пов'язані з відповідними кнопками у
        /// представленні для виконання відповідних дій.
        /// </summary>
