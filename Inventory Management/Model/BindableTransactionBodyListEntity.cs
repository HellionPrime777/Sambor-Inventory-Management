...
namespace Inventory_Management.Model
{
    ...
    {
        /// <summary>
        /// BindableTransactionBodyListEntity дозволяє прив'язувати дані з об'єкта TransactionBodyListEntity до представлення і реагувати на зміни значень цих даних.
        /// </summary>
