...
namespace DataLayer
{
    ...
    /// </summary>
    /// Цей код використовує Entity Framework для підключення до бази даних, виконання запитів та здійснення операцій з базою даних. 
    /// Він також містить логування подій за допомогою бібліотеки log4net.
