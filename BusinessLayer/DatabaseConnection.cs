...
{
    //Цей код дозволяє перевіряти з'єднання з базою даних, змінювати і створювати базу даних,
    //а також зберігати налаштування бази даних у файлі DatabaseSettings.txt.
